...
class DemocourseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('courses')->insert([
            ...
            'short_desc' => 'Learn all the tricks that can be wrecked on coyote\'s with pencil and crayon.',
            'long_desc' => NULL,
            'objective' => '<p>Introduce and highlight features of the pencile and crayon.</p>',
            'eval_type' => 'Online',
            'price' => 1000,
            'created_at' => '2020-05-29 14:30:20',
            'updated_at' => '2021-07-26 07:32:43'
